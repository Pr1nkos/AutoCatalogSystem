...
1. **Просмотр автомобилей**: При запуске приложения на главной странице отображаются доступные автомобили. Вы можете
   просматривать их и выбирать интересующие вас модели.
